<html>
	...
	<body>
		<div id="mainarea">
			<h1><u>CUSTOMER BAKERY CONTACT FORM</u></h1>
			<form  method="POST" action="module8submit.php">
				<br><br>
				<div class="aarea" ><b>Customer's Name</b></div>
				<div class="barea">
					<input type="text"  name="c_name" placeholder="Enter your name" class="carea"/>
				</div>
				
				<div class="aarea" ><b>Customer's Email</b></div>
				<div class="barea">
					<input type="email"  name="c_email" placeholder="Enter your email id" class="carea"/>
				</div>
				
				<div class="aarea" ><b>Customer's Mobile No.</b></div>
				<div class="barea">
					<input type="number"  name="c_mobile" placeholder="Enter your mobile no." class="carea"/>
				</div>
				
				
				<div class="darea"><b>Query Box !</b></div>
				<div>
					<textarea name="qbox" class="earea">
					</textarea>
				</div>
				<div id="farea">
